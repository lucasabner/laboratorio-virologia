<body class="hhold-transition skin-green sidebar-mini">
    <script>
    (function() {
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel-body">
                            ...
                            <?php echo 'Resultado: LV' . $amostra_id . date("/y\ ", strtotime(getDataRegistro($amostra_id)))?>
                            </h1>
                            <form method="POST" name="form_exame"
                                action="<?php echo base_url() ?>exame/update_resultado/<?php echo $exame_id ?>/<?php echo $amostra_id ?>">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <select name="Concelho" class="form-control" size="1" id="COMBOCID" disabled>
                                ...
                                <input type="hidden" name="amostra_qtd_id[]" value="<?= $item->amostra_qtd_id ?>">
                                <div class="col-lg-6 form-group">
                                    <label>Amostra</label>
                                    <textarea oninput="eylem(this, this.value)" class="form-control elasticteste"
                                        disabled><?= $item->identificador ?></textarea>
                                </div>

                                <div class="col-lg-6 form-group">
                                    <label>Resultado</label>
                                    <textarea required oninput="eylem(this, this.value)"
                                        class="form-control elasticteste"
                                        name="resultado[]"><?= getResultado($exame_id, $item->amostra_qtd_id) ?> </textarea>
                                </div>
                                <?php
								}
								?>
